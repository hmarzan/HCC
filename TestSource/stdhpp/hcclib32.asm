...
__@ConOutName BYTE "CONOUT$",0
__@ConInName BYTE "CONIN$",0
...
__@SharedWrite	= 2;
__@SharedRead	= 1;
__@FileWrite	= 40000000h;
__@FileReadOnly	= 80000000h;
__@OpenExisting	= 3;
;//C O N S O L E  A P I 
__Internal_ConsoleIO_LX PROC
	mov eax, [esp+4];
				;string filePath,		+8
				;FileMode mode,			+0Ch
	...
	jnz OFFSET __InputConsole;
	push __@SharedWrite;
	push __@FileWrite;
	push __@OpenExisting;	
	push OFFSET __@ConOutName;
	call File_Open;
	ret
__InputConsole:
	push __@SharedRead;
	push __@FileReadOnly;
	push __@OpenExisting;		
	push OFFSET __@ConInName;
	call File_Open;
	ret
__Internal_ConsoleIO_LX ENDP

__Internal_ConsoleIO_L PROC
	push dword ptr [esp+4];
	call GetStdHandle;
	ret
__Internal_ConsoleIO_L ENDP

__Internal_ConsoleIO_Load EQU <__Internal_ConsoleIO_L>
...
Console_ClearScreen PROC
	...
	;call GetStdHandle;
	call __Internal_ConsoleIO_Load;
...
_doWhile:
	...
	mov ecx, dword ptr [ebp+0Ch]; y
    cdq
	div ecx; n == edx = x%y;
	mov ecx, dword ptr [ebp+0Ch]
	mov dword ptr [ebp+8], ecx; x = y;
	mov dword ptr [ebp+0Ch], edx; y = n;
	test edx,edx
	jnz OFFSET _doWhile;
